import { TermsBackground, TermsWrapper, BackLink } from "./Terms.styles";
    ...
    <TermsBackground>
      <TermsWrapper>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Lithuania
            </p>
          </li>
          <li>
            <p>
              ...
              in this Agreement) refers to Learn to code.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Learn to code, accessible from{" "}
              <a
                href="https://learn-to-code.netlify.app/"
                rel="external nofollow noopener"
              >
                https://learn-to-code.netlify.app/
              </a>
            </p>
          </li>
          <li>
